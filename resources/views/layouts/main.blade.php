...
<head>
    ...
    <!-- Our Custom CSS -->
    <link rel="stylesheet" href="{{ asset('css/frontend/style5.css') }}">
...
<div class="wrapper">
    ...
    <nav id="sidebar" style="background:#113372">
        <div class="sidebar-header">
            <h3><img src="{{asset('css/frontend/img/iiau.jpg')}}" alt="" width="80px" height="80px"></h3>
        </div>
        <ul class="list-unstyled components">
            ...
            <li class="">
                <a href="{{ route('students.index')}}" >@lang('pages.student')</a>
            </li>
            <li class="">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="nav navbar-nav ml-auto">
                        ...
                        @lang('pages.flat')
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('tillar', ['lang' => 'en']) }}">
                            eng
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('tillar', ['lang' => 'ru']) }}">
                            ru
                            </a>
                        </li>
                    @guest
